...
?>
  <head>
    ...
    <title>SistemaAmilat | Fundacion Shalom</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="<?php echo $ruta; ?>web/bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo $ruta; ?>lib/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo $ruta; ?>lib/ionicons.min.css">
    <!-- Theme style -->
  ...
  <style>
    ...
    <!-- date-range-picker -->
    <script src="<?php echo $ruta; ?>lib/moment.min.js"></script>
