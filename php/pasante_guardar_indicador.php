...
session_start();
    ...
    $resultadoinsertmovimiento = $mysqli->query($insertexpediente);
  	...
  	$insertexpediente2 = "UPDATE consulta SET Status=1,IdEnfermedad='$enfermedad',Diagnostico='$diagnostico',Comentarios='$comentarios',Otros='$otros', Activo=0, IdEstado=2 WHERE IdConsulta='$idconsulta'";
