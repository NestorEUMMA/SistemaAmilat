                    ...
                    <div class="box-header with-border">
                      <h3 class="box-title">Expedientes</h3>
                        ...
                        <div class="box-body">
                          ...
                          <form  action="recepcion_guardar_expediente2.php" method="post" id="demo-form" data-parsley-validate="">
                              ...
                              <div class="col-md-6">
                                <div class="form-horizontal" role="form">
                                  <div class="form-group">
                                    ...
                                    <label for="cboGeografia" class="col-sm-2 control-label">Departamento</label>
                                    <div class="col-sm-4">
                                      <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-flag"></i></div>
                                        <select class="form-control select2" style="width: 100%;" id="cboGeografia" name="" >
                                          <option value=""></option>
                                          <?php
                                    ...
                                    <label for="cboMunicipio" class="col-sm-2 control-label">Municipio</label>
                                    <div class="col-sm-4">
                                      <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-flag"></i></div>
                                        <select class="form-control select2" style="width: 100%;" id="cboMunicipio" name="cboGeografia" required=""></select>
                                      </div>
                                    </div>
