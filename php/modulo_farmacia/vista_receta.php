...
$query = "
SELECT b.NombreMedicamento as NOMBRE, truncate(a.cantidad, 0) as CANTIDAD, a.horas as HORAS, a.dias as DIAS, a.total as TOTAL, a.IdMedicamento as idmedicamento
...
<form action = "guardar_despacho.php" method = "POST">
  <table>
  <tr>
  <td>NOMBRE</td><td>CANTIDAD</td><td>HORAS</td><td>DIAS</td><td><td>TOTAL</td>
  </tr>
  <?php
  $i = 1;
  ...
  echo "
  <tr>
  <td>".$row['NOMBRE']."</td><td>".$row['CANTIDAD']."</td><td>".$row['HORAS']."</td><td>".$row['DIAS']."</td><td><input type='text' name = 'total".$i."' style = 'border: none; width: 100%;' readonly value='".$row['TOTAL']."'></td>
