...
{
header("Location: ../SistemaAmilat/php/app.php");
}
else
{
 ?>
...
<html>
  ...
  <link rel="stylesheet" href="web/css/presentational-only.css">
    ...
    <div class="login-box">
        <div >
          ...
          <div class="login-box-body">
              <h4 class="login-box-msg">SISTEMA TPV </br> INICIO DE SESION</h4>
              <form method="POST">
