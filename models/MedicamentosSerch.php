...
/**
 * MedicamentosSerch represents the model behind the search form about `app\models\Medicamentos`.
 */
class MedicamentosSerch extends Medicamentos
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['NombreMedicamento', 'Existencia', 'NombreComercial'], 'safe'],
